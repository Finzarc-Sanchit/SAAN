...
const inputClassName =
  'h-12 w-full border border-neutral-300 bg-paper px-4 text-body text-ink outline-none transition-colors placeholder:text-neutral-500 focus:border-ink disabled:cursor-not-allowed disabled:bg-neutral-100 disabled:text-neutral-500';
      ...
      <div className="grid min-w-0 gap-8 xl:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] xl:gap-14">
        <div>
          ...
          <button
            ...
            className="mt-6 inline-flex min-h-11 w-full items-center justify-center border border-ink px-5 text-ui text-ink transition-colors hover:bg-ink hover:text-paper focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink sm:w-auto"
          >
        ...
        {isEditing ? (
          ...
          >
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="inline-flex min-h-11 w-full items-center justify-center bg-ink px-6 text-ui text-paper transition-colors hover:bg-neutral-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
            >
          ...
          <div>
            ...
            <dl className="grid gap-x-8 gap-y-7 sm:grid-cols-2">
              <div className="border-b border-neutral-300 pb-5">
                <dt className="text-ui text-neutral-500">First name</dt>
                <dd className="mt-2 text-body-medium text-ink">{user.firstName}</dd>
              </div>
              <div className="border-b border-neutral-300 pb-5">
                <dt className="text-ui text-neutral-500">Last name</dt>
                <dd className="mt-2 text-body-medium text-ink">{user.lastName}</dd>
              </div>
              <div className="border-b border-neutral-300 pb-5">
                <dt className="text-ui text-neutral-500">Email address</dt>
                <dd className="mt-2 break-all text-body-medium text-ink">
                  {user.email}
                </dd>
              </div>
              <div className="border-b border-neutral-300 pb-5">
                <dt className="text-ui text-neutral-500">Mobile number</dt>
                <dd className="mt-2 text-body-medium text-ink">
                  {user.mobileNumber || 'Not provided'}
                </dd>
              </div>
              <div className="border-b border-neutral-300 pb-5">
                <dt className="text-ui text-neutral-500">Date of birth</dt>
                <dd className="mt-2 text-body-medium text-ink">
                  {user.dateOfBirth
